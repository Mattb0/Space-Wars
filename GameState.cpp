	...
	: State(target, states)
{
	...
	this->deathSound.loadFromFile("sound/sfx/explode3.wav");
	this->sfx.setBuffer(deathSound);
	...
	this->HighScore.setString("High Score: " + std::to_string(this->highScore));
	this->HighScore.setPosition(WIN_W - 150, 0);
